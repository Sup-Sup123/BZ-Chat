 ...
 *
 */
define(["config", "Entities"], function(QMCONFIG, Entities) {
  var self;
  ...
  Message.prototype = {
    ...
    create: function(params, ajax) {
      var message = {
        id:
          (params.extension && params.extension.message_id) ||
          params._id ||
          params.id ||
          null,
        ...
        type: params.type || "",
        date_sent:
          (params.extension && params.extension.date_sent) || params.date_sent,
        ...
        notification_type:
          ...
          null,
        dialog_id:
          (params.extension && params.extension.dialog_id) ||
          params.chat_dialog_id,
        read: params.read || false,
        attachment:
          (params.extension &&
            params.extension.attachments &&
            params.extension.attachments[0]) ||
        ...
        recipient_id:
          params.recipient_id ||
          (params.extension && params.extension.recipient_id) ||
          null,
        ...
        deleted_occupant_ids:
          ...
          null,
        room_name:
          (params.extension && params.extension.room_name) ||
          params.room_name ||
          null,
        room_photo:
          (params.extension &&
          ...
          (params.room_photo &&
            params.room_photo.replace("http://", "https://")) ||
          null,
        room_updated_date:
        ...
        dialog_update_info:
          ...
          null,
        callType:
          (params.extension && params.extension.callType) ||
          params.callType ||
          null,
        callState:
          (params.extension && params.extension.callState) ||
          params.callState ||
          null,
        caller:
          parseInt(params.extension && params.extension.caller) ||
          parseInt(params.caller) ||
          null,
        callee:
          parseInt(params.extension && params.extension.callee) ||
          parseInt(params.callee) ||
          null,
        callDuration:
          (params.extension && params.extension.callDuration) ||
          params.callDuration ||
          null,
        sessionID:
          (params.extension && params.extension.sessionID) ||
          params.sessionID ||
          null,
        latitude:
          (params.extension && params.extension.latitude) ||
          params.latitude ||
          null,
        longitude:
          (params.extension && params.extension.longitude) ||
          params.longitude ||
          null,
        stack: false,
      ...
      if (prevMsg) {
        if (online) {
          var lastMessageSender = +prevMsg.attr("data-id"),
            lastMessageDateSent = +prevMsg
              .find(".message-time")
              .attr("data-time");

          sameUser =
            curMsg.sender_id === lastMessageSender
              ? prevMsg.attr("id")
                ? true
                : false
              : false;
          sameTime =
            Math.floor(curMsg.date_sent / 60) ===
            Math.floor(lastMessageDateSent / 60)
              ? true
              : false;
        } else {
          ...
          sameTime =
            Math.floor(curMsg.date_sent / 60) ===
            Math.floor(prevMsg.date_sent / 60)
              ? true
              : false;
        }
