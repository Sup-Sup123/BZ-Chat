 ...
 *
 */
define(["config", "underscore", "Helpers", "Entities"], function(
  QMCONFIG,
  _,
  Helpers,
  Entities
  ...
  Dialog.prototype = {
    ...
    create: function(params) {
      var User = this.app.models.User,
        ...
        dialog = {
          ...
          room_photo:
            (params.photo && params.photo.replace("http://", "https://")) || "",
          occupants_ids: _.uniq(
            _.without(params.occupants_ids, User.contact.id)
          ),
          last_message:
            params.last_message ||
            (params.type === 2 ? "Notification message" : "Contact request"),
          last_message_date_sent: params.last_message_date_sent || time,
          room_updated_date:
            Date.parse(params.updated_at) || params.room_updated_date || time,
    ...
    createPrivate: function(idOrJid, isNew, dialog_id) {
      ...
      id =
        idOrJid.indexOf("@") > -1
          ? QB.chat.helpers.getIdFromNode(idOrJid)
          : idOrJid;
