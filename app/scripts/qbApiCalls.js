 ...
 *
 */
define(["jquery", "config", "Entities", "Helpers", "LocationView"], function(
  $,
  QMCONFIG,
  Entities,
  Helpers,
      ...
      QB.createSession(params, function(err, res) {
        if (err) {
          ...
          if (err.code === 401) {
            ...
            errMsg = parseErr.errors.email
              ? parseErr.errors.email[0]
              : parseErr.errors.base
              ? parseErr.errors.base[0]
              : parseErr.errors[0];
