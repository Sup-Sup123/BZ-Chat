...
requirejs.config({
  ...
  paths: {
    ...
    mCustomScrollbar:
      "../bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar",
    ...
    perfectscrollbar:
      "../bower_components/perfect-scrollbar/js/perfect-scrollbar.min",
...
requirejs(
  ...
  function($, QMCONFIG, Helpers, minEmoji, QM, Backbone, QBNotification) {
    var APP;
